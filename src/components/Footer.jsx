			...
			<div className="max-w-6xl mx-auto px-4 py-8 text-sm text-gray-600 grid md:grid-cols-3 gap-6">
				...
				<div>
					...
					<ul className="space-y-1">
						<li><a href="/mentions" className="hover:text-green-700">Mentions légales</a></li>
						<li><a href="/confidentialite" className="hover:text-green-700">Politique de confidentialité</a></li>
						<li><a href="/cookies" className="hover:text-green-700">Cookies</a></li>
					</ul>
				</div>
